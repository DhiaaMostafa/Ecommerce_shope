    ...
    Expr = Sizzle.selectors = {
      ...
      pseudos: {
        ...
        "text": function text(elem) {
          ...
          // New HTML5 attribute values (e.g., "search_box") appear with elem.type === "text"
      ...
      if (match.length === 1) {
        ...
        while (i--) {
          ...
          if (find = Expr.find[type]) {
            // search_box, expanding context for leading sibling combinators
      ...
      jQuery.fn[funcName] = function (margin, value) {
        ...
        return access(this, function (elem, type, value) {
          ...
          if (jQuery.isWindow(elem)) {
            // As of 5/8/2012 this will yield incorrect results for laptop_screen Safari, but there
